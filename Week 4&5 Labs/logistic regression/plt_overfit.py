...
class overfit_example():
    ...
    def linear_regression(self):
        ...
        #linear_model = Ridge(alpha=self.lambda_, normalize=True, max_iter=10000) #normalize argument was removed from library
        linear_model = Ridge(alpha=self.lambda_, max_iter=10_000)
